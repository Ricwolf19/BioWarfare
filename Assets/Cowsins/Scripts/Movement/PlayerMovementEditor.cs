            ...
            if (currentTab >= 0 || currentTab < tabs.Length)
            {
                switch (tabs[currentTab])
                {
                    ...
                    case "Movement":
                        ...
                        GUILayout.Box("", new GUILayoutOption[] { GUILayout.ExpandWidth(true), GUILayout.Height(8) });
                        EditorGUILayout.PropertyField(playerSettings.FindPropertyRelative("maxSlopeAngle"));
                    ...
                    case "Aim assist":
                        ...
                        if (applyAimAssistProp.boolValue)
                        {
                            ...
                            EditorGUILayout.PropertyField(playerSettings.FindPropertyRelative("aimAssistSensitivity"));
                            EditorGUI.indentLevel--;
                        }
