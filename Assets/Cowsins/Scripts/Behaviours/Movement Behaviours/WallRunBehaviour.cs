...
public class WallRunBehaviour
{
    ...
    public void FixedTick()
    {
        ...
        if (inputManager.Y > 0 && (wallLeft || wallRight) && CheckHeight() && playerMovement.CurrentSpeed * playerMultipliers.WeightMultiplier > playerMovement.WalkSpeed && !playerMovement.Grounded) WallRun();
        else Exit();
    }
