...
namespace cowsins
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        #region variables
        // Inputs
        public bool Jumping, Sprinting, Crouching, Dashing, Shooting, Reloading, Aiming, Melee, Inspecting, Interacting, StartInteraction, Dropping, Nextweapon, Previousweapon,
            Pausing, OpenInventory, OpenFavMenu, ToggleFlashlight, Grappling, BackUI, SelectUI, WestButtonUI, NorthButtonUI;
        public float X, Y, Scrolling, Mousex, Mousey, Controllerx, Controllery;
