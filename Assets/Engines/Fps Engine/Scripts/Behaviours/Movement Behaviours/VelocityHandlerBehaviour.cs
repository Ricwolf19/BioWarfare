...
public class VelocityHandlerBehaviour 
{
    ...
    private void HandleIdle()
    {
        ...
        playerMovement.CurrentSpeed = playerSettings.autoRun ? playerMovement.RunSpeed : playerMovement.WalkSpeed;
    ...
    {
        if (inputManager.Crouching && !playerMovement.IsIdle)
        {
        ...
        if (playerMovement.IsIdle) playerMovement.CurrentSpeed = 0;
    }
    ...
    private bool CanSprint()
    {
        ...
        if (shooting && !playerSettings.canRunWhileShooting) return false;
